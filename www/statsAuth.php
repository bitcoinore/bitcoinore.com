...
$BTC_per_block = $B; // don't keep this hardcoded
...
<?php
echo "<center><table class=\"stats_lastblocks\" width='100%' style='font-size:13px;'>";
echo "<tr style='background-color:#B6DAFF;'>".
     "<th scope=\"col\" align='left'>Team Name</th><th scope=\"col\" align='left'>Shares Count</th> <th scope=\"col\" align='left'>Stale Shares</th> <th scope=\"col\" align='left'>Shares this round</th> <th scope=\"col\" align='left'>Hashrate</th> <th scope=\"col\" align='left'>Round Estimate</th></tr>";
$result = mysql_query("SELECT name, share_count, stale_share_count, shares_this_round, hashrate, round_estimate FROM teams order by name");
while($resultrow = mysql_fetch_object($result)) {
        echo "<tr>";
        echo "<td>" . $resultrow->name . "</td>";
        echo "<td>" . $resultrow->share_count . "</td>";
        echo "<td>" . $resultrow->stale_share_count . "</td>";
        echo "<td>" . $resultrow->shares_this_round . "</td>";
        echo "<td>" . $resultrow->hashrate . "</td>";
        echo "<td>" . $resultrow->round_estimate . "</td>";
        echo "</tr>";
}
echo "</table>";
?>
